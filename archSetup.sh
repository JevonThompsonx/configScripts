...
sudo pacman -Syu 
sudo pacman -S git curl neovim nodejs npm fish unzip ripgrep python-pip zoxide python-virtualenv gcc base-devel wget zoxide fastfetch alacritty foot librewolf-bin vivaldi eza obsidian localsend freetube-bin tailscale lazygit selene-bin webapp-manager ttf-fira-code ttf-firacode-nerd freedownloadmanager
